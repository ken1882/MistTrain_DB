const ASSET_HOST = 'https://assets-ak.mist-train-girls.com/production-client-web-assets';
const STATIC_HOST = 'https://assets-ak.mist-train-girls.com/production-client-web-static';
